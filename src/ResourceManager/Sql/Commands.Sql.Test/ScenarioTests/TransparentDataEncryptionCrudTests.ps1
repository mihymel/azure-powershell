...
#>
function Test-TransparentDataEncryptionProtectorGetSet
{
	# Setup
	...
	$keyDrop = Remove-AzureRmSqlServerKeyVaultKey -ServerName $params.ServerName -ResourceGroupName $params.rgName -KeyId $params.keyId
	Assert-AreEqual $params.keyId $keyDrop.Uri
}
